...
con = sql.connect(
    r'D:\LinhTinh\sql-murder-mystery.db', check_same_thread=False)
queries = [
    '''
SELECT *
...
class GameBackend(Resource):
    def post(self):
        try:
            ...
            if os.path.isfile(r'.\SQL-murder-Mystery\sqlgame\src\output.png'):
                os.remove(
                    r'.\SQL-murder-Mystery\sqlgame\src\output.png')
            dfi.export(queryResult, './SQL-murder-Mystery/sqlgame/src/output.png',
